...
<section class="max-w-7xl mx-auto px-6 py-12">
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-3">
            <h2 class="text-xl font-black text-gray-900 uppercase tracking-tight mb-6">Edit Profile</h2>
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('profile.update') }}">
                        ...
                        <div class="flex items-center gap-4 mt-6 pt-5 border-t border-gray-100">
                            <button type="submit"
                                class="bg-gray-900 hover:bg-gray-800 text-white px-8 py-2.5 text-sm font-semibold tracking-wide transition">
                                Save Changes
                            </button>
                            <a href="{{ route('profile.index') }}" class="text-sm text-gray-500 hover:text-gray-700 transition">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
            @else
            <div class="border border-dashed border-gray-300 py-12 text-center text-gray-400">
                <p class="text-lg">Anda tidak memiliki akses untuk mengedit profil.</p>
            </div>
            @endif
