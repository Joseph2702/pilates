@extends('layouts.app')
@section('title', 'Sign In - Femm Pilates')
...
<section class="min-h-[80vh] flex items-center justify-center bg-gray-50 py-16 px-6">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-black text-gray-900 uppercase tracking-tight">Welcome Back</h1>
            <p class="text-gray-500 text-sm mt-2">Sign in to your account to manage bookings.</p>
        </div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="remember" class="w-4 h-4 text-purple-500 border-gray-300 focus:ring-purple-400">
        ...
        <p class="text-center text-sm text-gray-500 mt-6">
            ...
            <a href="{{ route('web.register') }}" class="text-purple-600 font-semibold hover:text-purple-700">Register here</a>
        </p>
    </div>
</section>
@endsection
